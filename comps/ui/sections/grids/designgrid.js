    ...
    return (
            <div className="container">
                ...
                <style jsx>{`
                    ...
                    @media(min-width: 2560px) {.container {margin: -25rem 0 0 0;}.row {flex-direction: row;} .square{width: 500px; height: 500px;} .rect{width: 800px; height: 500px;}}
                    @media(min-width: 3000px) {.row {flex-direction: row;} .square{width: 600px; height: 600px;}.rect {width: 900px; height: 600px;}}
                `}</style>
            </div>
)}
